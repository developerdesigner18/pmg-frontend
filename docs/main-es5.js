...
var AfficheFilmComponent = /** @class */ (function () {
    function AfficheFilmComponent(filmService) {
        this.filmService = filmService;
    }
    AfficheFilmComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AfficheFilmComponent.ctorParameters = function () { return [
...
var AfficheSerieComponent = /** @class */ (function () {
    function AfficheSerieComponent(serieService) {
        this.serieService = serieService;
    }
    AfficheSerieComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AfficheSerieComponent.ctorParameters = function () { return [
...
var DetailFilmComponent = /** @class */ (function () {
    function DetailFilmComponent(route, filmService) {
        var _this = this;
        this.route = route;
        this.filmService = filmService;
        this.route.params
    ...
    DetailFilmComponent.prototype.getFilmByName = function (id) {
        var _this = this;
    ...
    DetailFilmComponent.ctorParameters = function () { return [
...
var DetailSerieComponent = /** @class */ (function () {
    function DetailSerieComponent(route, serieService) {
        var _this = this;
        this.route = route;
        this.serieService = serieService;
        this.route.params
    ...
    DetailSerieComponent.prototype.getFilmByName = function (id) {
        var _this = this;
    ...
    DetailSerieComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var FilmService = /** @class */ (function () {
    ...
    FilmService.prototype.getFilm = function () {
        return this.http.get('https://api.themoviedb.org/3/discover/movie?api_key=87dfa1c669eea853da609d4968d294be&language=fr-FR&sort_by=popularity.desc&page=5')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (data) { return data; }));
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(trendService) {
...
var NavComponent = /** @class */ (function () {
    function NavComponent(searchService, router, route) {
        this.searchService = searchService;
        this.router = router;
        this.route = route;
    }
    NavComponent.prototype.onSubmit = function (f) {
        console.log('param : ' + f);
        location.reload();
...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.getResult = function (name) {
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(route, searchService) {
        ...
        this.searchService = searchService;
        this.route.params
            .subscribe(function (params) { return _this.id = params.find; });
    }
    SearchComponent.prototype.ngOnInit = function () {
        this.getResult(this.id);
    };
    SearchComponent.prototype.getResult = function (id) {
        var _this = this;
        console.log(id);
...
var TrendingService = /** @class */ (function () {
    ...
    TrendingService.prototype.getNowPlaying = function () {
        return this.http.get('https://api.themoviedb.org/3/movie/now_playing?api_key=87dfa1c669eea853da609d4968d294be&language=fr-FR&page=1')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (test) { return test; }));
    };
